...
DEFAULTS = {
    ...
    "giocatore","__giocatore_norm",
    "match_flag","match_method","similarity",
    # Common main-votes columns (right). If they don't exist, they'll be ignored.
    "Voto_right","Gf_right","Gs_right","Rp_right","Rs_right","Rf_right","Au_right","Amm_right","Esp_right","Ass_right",
],
...
def main():
    ...
    if votes_dir:
        ...
        if output_reduced:
            ...
            with pd.ExcelWriter(output_reduced, engine="xlsxwriter") as w:
